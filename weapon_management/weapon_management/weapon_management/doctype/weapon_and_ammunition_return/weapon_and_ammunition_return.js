...
frappe.ui.form.on("Weapon and Ammunition Return", {
    returned: function (frm) {
        ...
        if (frm.doc.returned > frm.doc.available_quantity || frm.doc.returned < 1) {
            frm.set_value('returned', ' ');
        ...
        if (frm.doc.returned) {
            frappe.call({
                ...
                args: {
                    availableQuantity: frm.doc.available_quantity,
...
frappe.ui.form.on("Weapon and Ammunition Return", {
    empty_case_returned: function (frm) {
        ...
        if (frm.doc.empty_case_returned > frm.doc.quantity_used || frm.doc.empty_case_returned < 1) {
            frm.set_value('empty_case_returned', ' ');
        }
        ...
        if (frm.doc.returned) {
            frappe.call({
                ...
                args: {
                    quantityUsed: frm.doc.quantity_used,

...
@frappe.whitelist()
def get_weapon_names(weaponCategory):
    weaponNames = frappe.get_all('Weapon Master', filters={'weapon_category': weaponCategory}, fields=['weapon_name'])
    weaponNames = [weapon_names['weapon_name'] for weapon_names in weaponNames]
    return weaponNames
